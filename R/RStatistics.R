...
#pvalue es 0.1 así que seguimos sin pasar el corte, es hipótesis nula (por encima de o.o5)
...
mean(y)
wilcox.test(x,y,alternative="g")#seguimos en hipotesis nula; las muestras son muy parecidas, no hay evidencia etadistica para decir que son diferentes
